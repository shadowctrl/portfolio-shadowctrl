...
const sendEmails = async (name, mail, description) => {
	const userMailOptions = {
		...
		text: `Hi ${name},\n\nThank you so much for reaching out to us! I truly appreciate your message and value your input. I'm dedicated to providing you with a prompt response, and I will get back to you shortly.\n\nIf you have any urgent questions or need immediate assistance, please feel free to reach out to us directly at query@shadowctrl.me or on social handles.\n\nBest regards,\nVijayaraghavan,\nFounder & Lead Developer - Asynx Private Limited,\nhttps://asynx.in.`,
	};
